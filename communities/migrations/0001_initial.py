# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2017-03-20 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_html', models.TextField(blank=True, default=b'', editable=False)),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.IntegerField(choices=[(0, b'banned'), (1, b'member'), (2, b'moderator'), (3, b'admin')], default=1)),
